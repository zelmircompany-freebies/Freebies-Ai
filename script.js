        ...
        if (!window.openClerkSignInSafe) {
            window.openClerkSignInSafe = async function (btnEl) {
                ...
                if (window.Clerk && clerkReady) {
                    ...
                    alert('Could not connect to the sign-in service. Please check your connection (VPN/ad-block can sometimes block this) and try again.');
                }
            };
        }
